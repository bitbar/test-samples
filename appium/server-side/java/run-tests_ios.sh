...
export DYLD_FALLBACK_LIBRARY_PATH=${DYLD_LIBRARY_PATH}:$PWD/lib/mac/opencv:/Users/Shared/libimobiledevice-binaries-master:/usr/local/opt/libimobiledevice/lib
...
appium-1.4 -U ${UDID} --command-timeout 120 --log-no-colors --log-timestamp
...
cat ios-webkit-debug-proxy.log
...
ls -la /usr/local/opt/libimobiledevice/lib
ls -la /usr/local/opt/libimobiledevice
## Post-processing
