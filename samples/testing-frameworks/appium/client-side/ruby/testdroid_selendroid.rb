...
testdroid_app_file = "bitbar-android-sample.apk" 
...
def upload_application(file_path, username, password)
  ...
  c.verbose = true
  c.http_post(Curl::PostField.file('bitbar-android-sample.apk', file_path))
  resp = JSON.parse(c.body_str)

  @testdroid_app = resp["value"]["uploads"]["bitbar-android-sample.apk"]
end
