...
testdroid_app_file = "bitbar-ios-sample.ipa" 
...
def upload_application(file_path, username, password)
  ...
  c.verbose = true
  c.http_post(Curl::PostField.file('bitbar-ios-sample.ipa', file_path))
  resp = JSON.parse(c.body_str)

  @testdroid_app = resp["value"]["uploads"]["bitbar-ios-sample.ipa"]
end
