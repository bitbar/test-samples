...
public class TestdroidImageRecognitionAndroid {
    public static TestdroidAppiumDriverAndroid driver;
    public Logger logger = LoggerFactory.getLogger(TestdroidImageRecognitionAndroid.class);
    ...
    public static TestdroidAppiumDriverAndroid getDriverAndroid(TestdroidAppiumClient client) throws Exception {
        // Wait one hour for free device
        client.setDeviceWaitTime(3600);
        client.setPlatformName(client.APPIUM_PLATFORM_ANDROID);

        // Initiate the webdriver. Capabilities must be set by now.
        driver = client.getAndroidDriver();
    ...
    public String getScreenshotsFolder() {
        return "target/reports/screenshots/android/";
    }
